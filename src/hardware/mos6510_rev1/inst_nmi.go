...
//
//go:nosplit
func (er *Executor) InstOpNMI(cpu *CPU) {
	//internal operation
...
//
//go:nosplit
func (er *Executor) InstOpNMI1(cpu *CPU) {
	//internal operation
	if _, ok := cpu.bus.Read(cpu.pc); !ok {
		return
	}
...
//
//go:nosplit
func (er *Executor) InstOpNMI2(cpu *CPU) {
...
//
//go:nosplit
func (er *Executor) InstOpNMI3(cpu *CPU) {
...
//
//go:nosplit
func (er *Executor) InstOpNMI4(cpu *CPU) {
...
//
//go:nosplit
func (er *Executor) InstOpNMI5(cpu *CPU) {
...
//
//go:nosplit
func (er *Executor) InstOpNMI6(cpu *CPU) {
