...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ(cpu *CPU) {
	//internal operation
...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ1(cpu *CPU) {
	//internal operation
	if _, ok := cpu.bus.Read(cpu.pc); !ok {
		return
	}
...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ2(cpu *CPU) {
...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ3(cpu *CPU) {
...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ4(cpu *CPU) {
...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ5(cpu *CPU) {
...
//
//go:nosplit
func (er *ControlUnit) InstOpIRQ6(cpu *CPU) {
