...
func NewMath(factory *objects.Factory) *Math {
	...
	constants := map[string]objects.IObject{
		"E":       factory.NewFloat(math.E),
		"Pi":      factory.NewFloat(math.Pi),
		"Phi":     factory.NewFloat(math.Phi),
		"Sqrt2":   factory.NewFloat(math.Sqrt2),
		"SqrtE":   factory.NewFloat(math.SqrtE),
		"SqrtPi":  factory.NewFloat(math.SqrtPi),
		"SqrtPhi": factory.NewFloat(math.SqrtPhi),
		"Ln2":     factory.NewFloat(math.Ln2),
		"Log2E":   factory.NewFloat(math.Log2E),
		"Ln10":    factory.NewFloat(math.Ln10),
		"Log10E":  factory.NewFloat(math.Log10E),
	}
