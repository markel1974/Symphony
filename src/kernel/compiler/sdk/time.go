...
func (t *Time) ParseDuration(args ...objects.IObject) (objects.IObject, error) {
	...
	if err != nil {
		return t.factory.NewError(objects.FrameUndefined, err.Error()), nil
	}
	return t.factory.NewInt(objects.FrameUndefined, int64(dur)), nil
}
...
func (t *Time) Since(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(time.Since(t1))), nil
}
...
func (t *Time) Until(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(time.Until(t1))), nil
}
...
func (t *Time) DurationHours(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewFloat(objects.FrameUndefined, time.Duration(i1).Hours()), nil
}
...
func (t *Time) DurationMinutes(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewFloat(objects.FrameUndefined, time.Duration(i1).Minutes()), nil
}
...
func (t *Time) DurationNanoseconds(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, time.Duration(i1).Nanoseconds()), nil
}
...
func (t *Time) DurationSeconds(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewFloat(objects.FrameUndefined, time.Duration(i1).Seconds()), nil
}
...
func (t *Time) DurationString(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewString(objects.FrameUndefined, time.Duration(i1).String())
}
...
func (t *Time) MonthString(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewStringNoSize(objects.FrameUndefined, time.Month(i1).String()), nil
}
...
func (t *Time) Date(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, time.Date(int(i1), time.Month(i2), int(i3), int(i4), int(i5), int(i6), int(i7), time.Now().Location())), nil
}
...
func (t *Time) Now(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, time.Now()), nil
}
...
func (t *Time) Parse(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, parsed), nil
}
...
func (t *Time) Unix(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, time.Unix(i1, i2)), nil
}
...
func (t *Time) Add(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, t1.Add(time.Duration(i2))), nil
}
...
func (t *Time) Sub(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Sub(t2))), nil
}
...
func (t *Time) AddDate(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, v), nil
}
...
func (t *Time) TimeYear(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Year())), nil
}
...
func (t *Time) TimeMonth(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Month())), nil
}
...
func (t *Time) TimeDay(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Day())), nil
}
...
func (t *Time) TimeWeekday(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Weekday())), nil
}
...
func (t *Time) TimeHour(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Hour())), nil
}
...
func (t *Time) TimeMinute(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Minute())), nil
}
...
func (t *Time) TimeSecond(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Second())), nil
}
...
func (t *Time) TimeNanosecond(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, int64(t1.Nanosecond())), nil
}
...
func (t *Time) TimeUnix(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, t1.Unix()), nil
}
...
func (t *Time) TimeUnixNano(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewInt(objects.FrameUndefined, t1.UnixNano()), nil
}
...
func (t *Time) TimeFormat(args ...objects.IObject) (objects.IObject, error) {
	...
	s := t1.Format(s2)
	return t.factory.NewString(objects.FrameUndefined, s)
}
...
func (t *Time) ToLocal(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, t1.Local()), nil
}
...
func (t *Time) ToUTC(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewTime(objects.FrameUndefined, t1.UTC()), nil
}
...
func (t *Time) TimeLocation(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewString(objects.FrameUndefined, t1.Location().String())
}
...
func (t *Time) TimeString(args ...objects.IObject) (objects.IObject, error) {
	...
	return t.factory.NewString(objects.FrameUndefined, t1.String())
}
