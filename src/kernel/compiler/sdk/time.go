...
func NewTime(factory *objects.Factory) *Time {
	...
	container := []*objects.FuncPackage{
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Sleep", t.Sleep),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "ParseDuration", t.ParseDuration),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Since", t.Since),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Until", t.Until),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "DurationHours", t.DurationHours),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "DurationMinutes", t.DurationMinutes),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "DurationNanoseconds", t.DurationNanoseconds),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "DurationSeconds", t.DurationSeconds),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "DurationString", t.DurationString),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "MonthString", t.MonthString),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Date", t.Date),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Now", t.Now),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Parse", t.Parse),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Unix", t.Unix),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Add", t.Add),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "AddDate", t.AddDate),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Sub", t.Sub),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "After", t.After),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "Before", t.Before),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeYear", t.TimeYear),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeMonth", t.TimeMonth),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeDay", t.TimeDay),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeWeekday", t.TimeWeekday),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeHour", t.TimeHour),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeMinute", t.TimeMinute),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeSecond", t.TimeSecond),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeNanosecond", t.TimeNanosecond),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeUnix", t.TimeUnix),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeUnixNano", t.TimeUnixNano),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeFormat", t.TimeFormat),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeLocation", t.TimeLocation),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "TimeString", t.TimeString),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "is_zero", t.IsZero),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "to_local", t.ToLocal),
		factory.NewFuncPackage(objects.FrameStatic, objects.FuncPackageDef, "to_utc", t.ToUTC),
	}
