...
func NewLibrary(factory objects.IGateKeeper, process *Process) *Library {
	...
	container := []objects.IObject{
		factory.NewFuncExternal(objects.FrameStatic, "Printf", l.doPrintf),
		factory.NewFuncExternal(objects.FrameStatic, "CreateTimer", l.doCreateTimer),
		factory.NewFuncExternal(objects.FrameStatic, "IsActive", l.doIsActive),
		factory.NewFuncExternal(objects.FrameStatic, "Kill", l.doKill),
		factory.NewFuncExternal(objects.FrameStatic, "KillForeground", l.doKillForeground),
		factory.NewFuncExternal(objects.FrameStatic, "KillAll", l.doKillAll),
		factory.NewFuncExternal(objects.FrameStatic, "CWDSet", l.doCWDSet),
		factory.NewFuncExternal(objects.FrameStatic, "CWDName", l.doCWDName),
		factory.NewFuncExternal(objects.FrameStatic, "CWDPath", l.doCWDPath),
		factory.NewFuncExternal(objects.FrameStatic, "CWDDirectoryListing", l.doCWDDirectoryListing),
		factory.NewFuncExternal(objects.FrameStatic, "GetScreenSize", l.doGetScreenSize),
		factory.NewFuncExternal(objects.FrameStatic, "PaintRequest", l.doPaintRequest),
		factory.NewFuncExternal(objects.FrameStatic, "ProcessExec", l.doProcessExec),
		factory.NewFuncExternal(objects.FrameStatic, "WindowsSelectionBegin", l.doWindowsSelectionBegin),
		factory.NewFuncExternal(objects.FrameStatic, "CWDSet", l.doWindowsSelectionEnd),
		factory.NewFuncExternal(objects.FrameStatic, "WindowsSelectionOptions", l.doWindowsSelectionOptions),
		factory.NewFuncExternal(objects.FrameStatic, "WindowsSelectionNext", l.doWindowsSelectionNext),
		factory.NewFuncExternal(objects.FrameStatic, "WindowsSelectionPrevious", l.doWindowsSelectionPrevious),
		factory.NewFuncExternal(objects.FrameStatic, "ProcessList", l.doProcessList),
		factory.NewFuncExternal(objects.FrameStatic, "ProcessSetForeground", l.doProcessSetForeground),
		factory.NewFuncExternal(objects.FrameStatic, "ProcessSetSelfForeground", l.doProcessSetSelfForeground),
		factory.NewFuncExternal(objects.FrameStatic, "Write", l.doWrite),
		factory.NewFuncExternal(objects.FrameStatic, "WritePromptEOL", l.doWritePromptEOL),
		factory.NewFuncExternal(objects.FrameStatic, "WritePromptLine", l.doWritePromptLine),
		factory.NewFuncExternal(objects.FrameStatic, "WriteColor", l.doWriteColor),
		factory.NewFuncExternal(objects.FrameStatic, "WriteForeground", l.doWriteForeground),
		factory.NewFuncExternal(objects.FrameStatic, "MoveCursorLeft", l.doMoveCursorLeft),
		factory.NewFuncExternal(objects.FrameStatic, "MoveCursorRight", l.doMoveCursorRight),
		factory.NewFuncExternal(objects.FrameStatic, "SaveCursor", l.doSaveCursor),
		factory.NewFuncExternal(objects.FrameStatic, "RestoreCursor", l.doRestoreCursor),
		factory.NewFuncExternal(objects.FrameStatic, "ClearScreen", l.doClearScreen),
		factory.NewFuncExternal(objects.FrameStatic, "SetExit", l.doSetExit),
		factory.NewFuncExternal(objects.FrameStatic, "Suggestion", l.doSuggestion),
		factory.NewFuncExternal(objects.FrameStatic, "Help", l.doHelp),
	}
	for _, obj := range container {
		if fn, ok := obj.(*objects.FuncExternal); ok {
			l.pkg[fn.Name()] = fn
		}
	}
	return l
