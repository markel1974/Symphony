...
func NewLibrary(factory objects.IGateKeeper, process *Process) *Library {
	...
	container := []objects.IObject{
		factory.NewFuncPackage("Printf", l.doPrintf),
		factory.NewFuncPackage("CreateTimer", l.doCreateTimer),
		factory.NewFuncPackage("IsActive", l.doIsActive),
		factory.NewFuncPackage("Kill", l.doKill),
		factory.NewFuncPackage("KillForeground", l.doKillForeground),
		factory.NewFuncPackage("KillAll", l.doKillAll),
		factory.NewFuncPackage("CWDSet", l.doCWDSet),
		factory.NewFuncPackage("CWDName", l.doCWDName),
		factory.NewFuncPackage("CWDPath", l.doCWDPath),
		factory.NewFuncPackage("CWDDirectoryListing", l.doCWDDirectoryListing),
		factory.NewFuncPackage("GetScreenSize", l.doGetScreenSize),
		factory.NewFuncPackage("PaintRequest", l.doPaintRequest),
		factory.NewFuncPackage("ProcessExec", l.doProcessExec),
		factory.NewFuncPackage("WindowsSelectionBegin", l.doWindowsSelectionBegin),
		factory.NewFuncPackage("CWDSet", l.doWindowsSelectionEnd),
		factory.NewFuncPackage("WindowsSelectionOptions", l.doWindowsSelectionOptions),
		factory.NewFuncPackage("WindowsSelectionNext", l.doWindowsSelectionNext),
		factory.NewFuncPackage("WindowsSelectionPrevious", l.doWindowsSelectionPrevious),
		factory.NewFuncPackage("ProcessList", l.doProcessList),
		factory.NewFuncPackage("ProcessSetForeground", l.doProcessSetForeground),
		factory.NewFuncPackage("ProcessSetSelfForeground", l.doProcessSetSelfForeground),
		factory.NewFuncPackage("Write", l.doWrite),
		factory.NewFuncPackage("WritePromptEOL", l.doWritePromptEOL),
		factory.NewFuncPackage("WritePromptLine", l.doWritePromptLine),
		factory.NewFuncPackage("WriteColor", l.doWriteColor),
		factory.NewFuncPackage("WriteForeground", l.doWriteForeground),
		factory.NewFuncPackage("MoveCursorLeft", l.doMoveCursorLeft),
		factory.NewFuncPackage("MoveCursorRight", l.doMoveCursorRight),
		factory.NewFuncPackage("SaveCursor", l.doSaveCursor),
		factory.NewFuncPackage("RestoreCursor", l.doRestoreCursor),
		factory.NewFuncPackage("ClearScreen", l.doClearScreen),
		factory.NewFuncPackage("SetExit", l.doSetExit),
		factory.NewFuncPackage("Suggestion", l.doSuggestion),
		factory.NewFuncPackage("Help", l.doHelp),
	}
