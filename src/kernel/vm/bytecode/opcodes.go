...
// OperandsOffset returns the total byte offset for the operands of the OpcodeDetails instance.
func (od *OpcodeDetails) OperandsOffset() int {
	return od.operandsOffset
}
