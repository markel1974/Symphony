...
func NewStrings(factory objects.IGateKeeper) IPackage {
	...
	container := []objects.IObject{
		factory.NewFuncExternal(objects.FrameStatic, "Compare", factory.FuncIssOi(strings.Compare)),
		factory.NewFuncExternal(objects.FrameStatic, "Contains", factory.FuncIssOb(strings.Contains)),
		factory.NewFuncExternal(objects.FrameStatic, "ContainsAny", factory.FuncIssOb(strings.ContainsAny)),
		factory.NewFuncExternal(objects.FrameStatic, "Count", factory.FuncIssOi(strings.Count)),
		factory.NewFuncExternal(objects.FrameStatic, "EqualFold", factory.FuncIssOb(strings.EqualFold)),
		factory.NewFuncExternal(objects.FrameStatic, "Fields", factory.FuncIsOsS(strings.Fields)),
		factory.NewFuncExternal(objects.FrameStatic, "HasPrefix", factory.FuncIssOb(strings.HasPrefix)),
		factory.NewFuncExternal(objects.FrameStatic, "HasSuffix", factory.FuncIssOb(strings.HasSuffix)),
		factory.NewFuncExternal(objects.FrameStatic, "Index", factory.FuncIssOi(strings.Index)),
		factory.NewFuncExternal(objects.FrameStatic, "IndexAny", factory.FuncIssOi(strings.IndexAny)),
		factory.NewFuncExternal(objects.FrameStatic, "Join", s.join),
		factory.NewFuncExternal(objects.FrameStatic, "LastIndex", factory.FuncIssOi(strings.LastIndex)),
		factory.NewFuncExternal(objects.FrameStatic, "LastIndexAny", factory.FuncIssOi(strings.LastIndexAny)),
		factory.NewFuncExternal(objects.FrameStatic, "Repeat", s.repeat),
		factory.NewFuncExternal(objects.FrameStatic, "Replace", s.replace),
		factory.NewFuncExternal(objects.FrameStatic, "Substring", s.Substring),
		factory.NewFuncExternal(objects.FrameStatic, "Split", factory.FuncIssOsS(strings.Split)),
		factory.NewFuncExternal(objects.FrameStatic, "SplitAfter", factory.FuncIssOsS(strings.SplitAfter)),
		factory.NewFuncExternal(objects.FrameStatic, "SplitAfterN", factory.FuncIssiOsS(strings.SplitAfterN)),
		factory.NewFuncExternal(objects.FrameStatic, "SplitN", factory.FuncIssiOsS(strings.SplitN)),
		factory.NewFuncExternal(objects.FrameStatic, "Title", factory.FuncIsOs(strings.Title)),
		factory.NewFuncExternal(objects.FrameStatic, "ToLower", factory.FuncIsOs(strings.ToLower)),
		factory.NewFuncExternal(objects.FrameStatic, "ToTitle", factory.FuncIsOs(strings.ToTitle)),
		factory.NewFuncExternal(objects.FrameStatic, "ToUpper", factory.FuncIsOs(strings.ToUpper)),
		factory.NewFuncExternal(objects.FrameStatic, "PadLeft", s.padLeft),
		factory.NewFuncExternal(objects.FrameStatic, "PadRight", s.padRight),
		factory.NewFuncExternal(objects.FrameStatic, "Trim", factory.FuncIssOs(strings.Trim)),
		factory.NewFuncExternal(objects.FrameStatic, "TrimLeft", factory.FuncIssOs(strings.TrimLeft)),
		factory.NewFuncExternal(objects.FrameStatic, "TrimPrefix", factory.FuncIssOs(strings.TrimPrefix)),
		factory.NewFuncExternal(objects.FrameStatic, "TrimRight", factory.FuncIssOs(strings.TrimRight)),
		factory.NewFuncExternal(objects.FrameStatic, "TrimSpace", factory.FuncIsOs(strings.TrimSpace)),
		factory.NewFuncExternal(objects.FrameStatic, "TrimSuffix", factory.FuncIssOs(strings.TrimSuffix)),
	}
