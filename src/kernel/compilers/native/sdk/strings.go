...
func NewStrings(factory objects.IGateKeeper) IPackage {
	...
	container := []objects.IObject{
		...
		factory.NewFuncPackage("ContainsAny", factory.FuncIssOb(strings.ContainsAny)),
		factory.NewFuncPackage("Count", factory.FuncIssOi(strings.Count)),
		factory.NewFuncPackage("EqualFold", factory.FuncIssOb(strings.EqualFold)),
		factory.NewFuncPackage("Fields", factory.FuncIsOsS(strings.Fields)),
		factory.NewFuncPackage("HasPrefix", factory.FuncIssOb(strings.HasPrefix)),
		factory.NewFuncPackage("HasSuffix", factory.FuncIssOb(strings.HasSuffix)),
		factory.NewFuncPackage("Index", factory.FuncIssOi(strings.Index)),
		factory.NewFuncPackage("IndexAny", factory.FuncIssOi(strings.IndexAny)),
		factory.NewFuncPackage("Join", s.join),
		factory.NewFuncPackage("LastIndex", factory.FuncIssOi(strings.LastIndex)),
		factory.NewFuncPackage("LastIndexAny", factory.FuncIssOi(strings.LastIndexAny)),
		factory.NewFuncPackage("Repeat", s.repeat),
		factory.NewFuncPackage("Replace", s.replace),
		factory.NewFuncPackage("Substring", s.Substring),
		factory.NewFuncPackage("Split", factory.FuncIssOsS(strings.Split)),
		factory.NewFuncPackage("SplitAfter", factory.FuncIssOsS(strings.SplitAfter)),
		factory.NewFuncPackage("SplitAfterN", factory.FuncIssiOsS(strings.SplitAfterN)),
		factory.NewFuncPackage("SplitN", factory.FuncIssiOsS(strings.SplitN)),
		factory.NewFuncPackage("Title", factory.FuncIsOs(strings.Title)),
		factory.NewFuncPackage("ToLower", factory.FuncIsOs(strings.ToLower)),
		factory.NewFuncPackage("ToTitle", factory.FuncIsOs(strings.ToTitle)),
		factory.NewFuncPackage("ToUpper", factory.FuncIsOs(strings.ToUpper)),
		factory.NewFuncPackage("PadLeft", s.padLeft),
		factory.NewFuncPackage("PadRight", s.padRight),
		factory.NewFuncPackage("Trim", factory.FuncIssOs(strings.Trim)),
		factory.NewFuncPackage("TrimLeft", factory.FuncIssOs(strings.TrimLeft)),
		factory.NewFuncPackage("TrimPrefix", factory.FuncIssOs(strings.TrimPrefix)),
		factory.NewFuncPackage("TrimRight", factory.FuncIssOs(strings.TrimRight)),
		factory.NewFuncPackage("TrimSpace", factory.FuncIsOs(strings.TrimSpace)),
		factory.NewFuncPackage("TrimSuffix", factory.FuncIssOs(strings.TrimSuffix)),
	}
