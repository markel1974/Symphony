...
func NewTime(factory objects.IGateKeeper) IPackage {
	...
	container := []objects.IObject{
		factory.NewFuncPackage("Sleep", t.sleep),
		factory.NewFuncPackage("ParseDuration", t.parseDuration),
		factory.NewFuncPackage("Since", t.since),
		factory.NewFuncPackage("Until", t.until),
		factory.NewFuncPackage("DurationHours", t.durationHours),
		factory.NewFuncPackage("DurationMinutes", t.durationMinutes),
		factory.NewFuncPackage("DurationNanoseconds", t.durationNanoseconds),
		factory.NewFuncPackage("DurationSeconds", t.durationSeconds),
		factory.NewFuncPackage("DurationString", t.durationString),
		factory.NewFuncPackage("MonthString", t.monthString),
		factory.NewFuncPackage("Date", t.date),
		factory.NewFuncPackage("Now", t.now),
		factory.NewFuncPackage("Parse", t.parse),
		factory.NewFuncPackage("Unix", t.unix),
		factory.NewFuncPackage("Add", t.add),
		factory.NewFuncPackage("AddDate", t.addDate),
		factory.NewFuncPackage("Sub", t.sub),
		factory.NewFuncPackage("After", t.after),
		factory.NewFuncPackage("Before", t.before),
		factory.NewFuncPackage("TimeYear", t.timeYear),
		factory.NewFuncPackage("TimeMonth", t.timeMonth),
		factory.NewFuncPackage("TimeDay", t.timeDay),
		factory.NewFuncPackage("TimeWeekday", t.timeWeekday),
		factory.NewFuncPackage("TimeHour", t.timeHour),
		factory.NewFuncPackage("TimeMinute", t.timeMinute),
		factory.NewFuncPackage("TimeSecond", t.timeSecond),
		factory.NewFuncPackage("TimeNanosecond", t.timeNanosecond),
		factory.NewFuncPackage("TimeUnix", t.timeUnix),
		factory.NewFuncPackage("TimeUnixNano", t.timeUnixNano),
		factory.NewFuncPackage("TimeFormat", t.timeFormat),
		factory.NewFuncPackage("TimeLocation", t.timeLocation),
		factory.NewFuncPackage("TimeString", t.timeString),
		factory.NewFuncPackage("IsZero", t.isZero),
		factory.NewFuncPackage("ToLocal", t.toLocal),
		factory.NewFuncPackage("ToUTC", t.toUTC),
	}
