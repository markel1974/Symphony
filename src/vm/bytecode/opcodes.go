...
func NewOpcodes() *Opcodes {
	...
	op.create(OpGlobalIndex, []OperandFeature{SzUint16, SzUint8}, "OpGlobalIndex")
	op.create(OpGlobalCopy, []OperandFeature{SzUint16, SzUint16}, "OpGlobalCopy")
	...
	op.create(OpLocalIndex, []OperandFeature{SzUint8, SzUint8}, "OpLocalIndex")
