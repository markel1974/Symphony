...
func New{{.StructName}}Reflect(r *{{.StructName}}, factory references.IComponentFactory, parent references.IComponent, identifier string, instance int, hardwareId string) *{{.StructName}}Reflect {
...
func (g *Generator) generateFile(inputFile string, packageName string, importName string, data *StructData) error {
