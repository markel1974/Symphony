...
func Compile(gk objects.IGateKeeper, seq core.ISequencer, loader bytecode.ILoader, sources []*FileInfo) (*bytecode.Bytecode, error) {
	if len(sources) == 0 {
		return nil, fmt.Errorf("no sources found")
	}
	c := _nativeCompiler.New(gk, loader, seq)
	if len(sources) == 1 {
